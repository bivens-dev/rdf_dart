    ...
    group('Syntax', () {
      group('Positive', () {
        ...
        test('string literal', () async {
          ...
          expect(parsedTriple.predicate, equals(Literal('string', XSD.string)));
        });
        ...
        test('bnode object', () async {
          ...
          expect(result.namedGraphs.length, equals(0));
          expect(firstTriple.subject, equals(IRITerm(IRI('http://example/s'))));
          expect(
          ...
          expect(secondTriple.object, equals(IRITerm(IRI('http://example/o'))));
        });
        ...
        test(r'literal with numeric escape4 \u', () async {
          ...
          expect(parsedTriple.predicate, equals(Literal('\u006F', XSD.string)));
        });
