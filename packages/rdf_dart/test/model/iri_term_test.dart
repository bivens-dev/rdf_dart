  ...
  group('IRI', () {
    group('Valid IRIs', () {
      ...
      test('with query parameters', () {
        expect(
          () => IRITerm(IRI('https://example.com/search?q=test')),
          returnsNormally,
        );
      });
      ...
      test('with fragment', () {
        expect(
          () => IRITerm(IRI('https://example.com/page#section')),
          returnsNormally,
        );
      });
    ...
    group('Valid Percent-Encoded IRIs', () {
      ...
      test('with several percent-encoding', () {
        expect(
          () => IRITerm(IRI('http://example.com/%41%42%43')),
          returnsNormally,
        );
      });
    ...
    group('Invalid Percent-Encoded IRIs', () {
      ...
      test('with invalid hex character', () {
        expect(
          () => IRITerm(IRI('http://example.com/path%2G')),
          throwsFormatException,
        );
      });
      test('with invalid hex characters', () {
        expect(
          () => IRITerm(IRI('http://example.com/path%GG')),
          throwsFormatException,
        );
      });
      test('with missing hex digits', () {
        expect(
          () => IRITerm(IRI('http://example.com/path%')),
          throwsFormatException,
        );
      });
      test('with only one hex digit', () {
        expect(
          () => IRITerm(IRI('http://example.com/%2')),
          throwsFormatException,
        );
      });
      test('with only one hex digit', () {
        expect(
          () => IRITerm(IRI('http://example.com/%a%b')),
          throwsFormatException,
        );
      });
      test('with incorrect hex encoding', () {
        expect(
          () => IRITerm(IRI('http://example.com/path%2GH')),
          throwsFormatException,
        );
      });
    });
    ...
    group('Invalid Control Character IRIs', () {
      ...
      test('with U+0080 in percent-encoded sequence', () {
        expect(
          () => IRITerm(IRI('http://example.com/%C2%80')),
          returnsNormally,
        );
      });
      test('with U+009F in percent-encoded sequence', () {
        expect(
          () => IRITerm(IRI('http://example.com/%C2%9F')),
          returnsNormally,
        );
      });
      test('with TAB', () {
